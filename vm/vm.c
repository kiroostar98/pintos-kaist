...
struct page *	//va를 인자로 넣었을 때 spt에서 해당 Page를 return
spt_find_page (struct supplemental_page_table *spt UNUSED, void *va UNUSED) {
	struct hash_elem *e;
	struct page *page = (struct page *)malloc(sizeof(struct page));  //malloc으로 page 할당
	page-> va = pg_round_down(va); // page의 시작 주소를 찾기 위해 round_down 함수 활용
